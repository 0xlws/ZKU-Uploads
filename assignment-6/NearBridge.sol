...
contract NearBridge is INearBridge, AdminControlled {
    ...
    // deposit eth, value send has to be equal to eth locked
    ...
    // check if signature of block producer is valid
    ...
    // update the state of the bridge contract
    ...
    // relayer adds a new block to light client if enough Eth locked
    ...
    // sets the number of block producers
    ...
    // return to-be verified hash of block
    ...
    // return to-be verified merkle root of a block
